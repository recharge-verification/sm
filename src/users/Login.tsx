        ...
        <>
            ...
            <div className="mx-3 mt-10">
                ...
                <div className="flex items-center space-x-1">
                    ...
                    <h3 className="text-[#660000] flex text-xl font-semibold font-serif">Authentifiés</h3>
                </div>
                <LoginFields />
            </div>
                ...
                <div>
                    {
                        links.map((link, index)=>(
                            <a href="/" className="text-blue-600 hover:underline tracking-tight inline-block text-base/8  text-[15px]" key={index}>{link.title}<span className="text-black">&nbsp;|&nbsp;</span></a>
                        ))
                    }
